...
# Yumi boot logo: if boot.bmp exists on the boot partition, display it
# immediately (centered). Replace or delete the file to change/disable it.
if test -e ${devtype} ${devnum} ${prefix}boot.bmp; then
	load ${devtype} ${devnum} ${load_addr} ${prefix}boot.bmp
